async function GetCall() {
  ...
  const responce = await fetch(
    `https://api.weatherapi.com/v1/current.json?key=915069c13d8f43d7a39144417251710&q=${a}&aqi=yes`
  );
...
async function GetCalla() {
  ...
  console.log(a);
  const responce = await fetch(
    `https://api.weatherapi.com/v1/current.json?key=915069c13d8f43d7a39144417251710&q=pune&aqi=yes`
  );
  const advice = await responce.json();
  console.log(advice);
